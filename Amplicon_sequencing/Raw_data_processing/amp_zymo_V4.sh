...
mi=240 #minumum length 240   #REf is 254bp
ma=260 #maximum length 260
ee=1 #expected error
...
#sr=19 #strip bases from right 
#sl=20 #strip bases from left
mi=230 #minumum length #PREVIOUS 290 - 395. Reference is 310+-67bp aprox 240 to 380 
ma=390 #maximum length
ee=1 #expected error
...
$vsearch --fastq_mergepairs $f --reverse ${f/1P/2P} --fastqout $o --fastq_allowmergestagger --log ./merged/out.txt 2> ./merged/out2.txt
